...
const generateOrderLabel = (order: Order, orderItems: OrderItem[], formatCurrency: (amount: number) => string, locale: string = 'en-US') => {
  ...
  checkPageBreak(30);
  pdf.setFontSize(14);
  pdf.text(`TOTAL: ${formatCurrency(order.totalAmount)}`, 20, yPosition);
  yPosition += 15;
...
function OrderManagement() {
  ...
  const handleUpdateTrackingInfo = async () => {
    if (!trackingOrder || !trackingFormData.trackingNumber || !trackingFormData.shippingService) {
      alert('Mohon lengkapi nomor resi dan jasa pengiriman.');
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        alert('Informasi tracking berhasil diperbarui!');
        ...
        throw new Error('Gagal memperbarui informasi tracking.');
      }
    } catch (error) {
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          ...
                          Track via {getShippingServiceFromOrder(selectedOrder)}
                        </a>
                        <Button
                          variant="ghost"
                          size="sm"
          ...
          {trackingOrder && (
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={handleUpdateTrackingInfo}>
                  Simpan
                </Button>
              </div>
            </div>
