        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md" data-testid="text-footer-description">
              Destinasi utama Anda untuk alat musik rock vintage dan modern serta aksesoris musik berkualitas. 
              Kami telah melayani musisi dan legenda rock selama lebih dari 15 tahun.
            </p>
