...
- **Platform Replit** (otomatis menyediakan environment lengkap)

### ✨ **Instalasi Mudah - Langkah Demi Langkah**

#### **Di Platform Replit (Recommended):**

1. **Fork Project:**
   - Klik tombol "Fork" di repository ini
   - Tunggu hingga project ter-copy ke workspace Replit Anda
...
3. **Jalankan Server:**
   ...
   npm run dev
   ```
   Atau klik tombol **"Run"** di Replit
...
5. **Akses Aplikasi:**
   - Website: `https://[your-repl-name].replit.dev`
...
### **Akses Aplikasi:**
- **🌐 Website**: https://[your-repl].replit.dev atau http://localhost:5000
- **👑 Admin Panel**: `/admin`
...
2. Masuk ke `/admin`
3. Buka "Payment Configuration"
4. Masukkan Midtrans Server Key dan Client Key
5. Test koneksi dan simpan

> **Catatan**: Konfigurasi Midtrans disimpan di database, bukan environment variables, untuk keamanan yang lebih baik.
