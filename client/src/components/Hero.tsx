      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
          <div className="text-center" data-testid="stat-instruments">
            <div className="text-3xl sm:text-4xl font-bebas text-orange-400 mb-2">{translations.hero?.statsInstruments}</div>
            <div className="text-sm sm:text-base text-gray-300">{translations.hero?.instrumentsLabel}</div>
          </div>
          <div className="text-center" data-testid="stat-years">
            <div className="text-3xl sm:text-4xl font-bebas text-orange-400 mb-2">{translations.hero?.statsExperience}</div>
            <div className="text-sm sm:text-base text-gray-300">{translations.hero?.experienceLabel}</div>
          </div>
          <div className="text-center" data-testid="stat-artists">
            <div className="text-3xl sm:text-4xl font-bebas text-orange-400 mb-2">{translations.hero?.statsArtists}</div>
            <div className="text-sm sm:text-base text-gray-300">{translations.hero?.artistsLabel}</div>
          </div>
        </div>
      </div>
